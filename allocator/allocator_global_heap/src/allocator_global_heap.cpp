...
{
    debug_with_guard("ALLOCATOR_GLOBAL_HEAP: start to get block memory state");
    ...
    debug_with_guard("ALLOCATOR_GLOBAL_HEAP: finish to get block memory state");
...
void allocator_global_heap::deallocate(void *at)
{
    ...
    debug_with_guard("ALLOCATOR_GLOBAL_HEAP: string state memory block: " + string_state_memory_blocks);
